              ...
              onClick={() => dialog.show(
                ...
                <div className={styles.berjualan} >
                  ...
                  <div className={styles['img-wrapper']} >
                    <a href="https://api.blanja.tw/sellerapp/android" target="_blank" >
                      <img className={styles.google} src="/static/img/google_play_badge.png" alt="Google Play Badge" />
                    </a>
                    <a href="https://api.blanja.tw/sellerapp/ios" target="_blank" >
...
>>>>>>> dab8b5bf9bfd05ac9754bcc57d086a04e878770c
